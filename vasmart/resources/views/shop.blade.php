                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <form>
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <button type="button" class="btn btn-outline-success add-to-cart" style="height: 35px; width: 150px; border-radius: 5px"  data-id_product="{{$value->product_id}}" name="add-to-cart">
