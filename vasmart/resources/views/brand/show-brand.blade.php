                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumbs-inner">
                            <h1 class="breadcrumbs-title">Thương hiệu sản phẩm</h1>
                            @foreach($brand_name as $key=>$name)
                            <h1 style="margin: -20px 0 20px 500px">  {{$name->brand_name}}</h1>
                            @endforeach
                            <ul class="breadcrumb-list">
                                ...
                                <li><a href="{{\Illuminate\Support\Facades\URL::to('shop')}}">Thương hiệu sản phẩm</a></li>
                                @foreach($brand_name as $key=>$name)
                                    <li>
                                        {{$name->brand_name}}
                                    </li>
                        ...
                        <div class="shop-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="grid-view" class="tab-pane active show" role="tabpanel">
                                    <div class="row">
                                        <!-- product-item start -->
                                        @foreach($brand_by_id as $key => $value_cate)
