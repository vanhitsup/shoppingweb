            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs-inner">
                        <h1 class="breadcrumbs-title">hoàn tất thanh toán</h1>
                        ...
                        <div class="tab-pane active" id="order-complete">
                            <div class="order-complete-content box-shadow">
                                <div class="thank-you p-30 text-center">
                                    <h2 style="color:#ea3434; font-style: italic" class="text-black-5 mb-0">Cảm ơn bạn đã đặt hàng. Đơn hàng của bạn đang được xử lý .</h2>
                                </div>
