                                            ...
                                            <tr>
                                                <td class="product-thumbnail" style="padding: 10px 20px" >
                                                    <div class="pro-thumbnail-img" style="width: 10%;">
                                                        <img src="{{\Illuminate\Support\Facades\URL::to('../public/uploads/products/'.$value->options->image)}}"  alt="">
                                                    </div>
                                                ...
                                                <td style="padding: 10px 20px"  class="product-price">{{number_format($value->price)}} đ</td>
                                                <td style="padding: 10px 20px"  class="product-quantity">
                                                    <form action="{{\Illuminate\Support\Facades\URL::to('update-cart-qty')}}" method="POST">
                                                        {{csrf_field()}}
                                                        <input type="text" value="{{$value->qty}}" name="cart_quantity" class="cart-plus-minus-box" >
                                                        <input type="hidden" value="{{$value->rowId}}" name="rowId_cart" class="form-control">
                                                        <input type="submit" value="Cập nhật" name="update_qty" class="btn btn-default btn-sm">
                                                    </form>
                                                </td>
                                                <td style="padding: 10px 20px"  class="product-subtotal">{{number_format($value->price*$value->qty)}} đ</td>
                                                <td style="padding: 10px 20px"   class="product-remove">
                                                    <a href="{{\Illuminate\Support\Facades\URL::to('/delete-cart/'.$value->rowId)}}"><i class="zmdi zmdi-close"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            <!-- tr -->
                                            ...
                                            <div class="payment-details box-shadow p-30 mb-50">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-title-2">Free Ship</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="td-title-1">Thuế (0%)</td>
                                                        <td class="td-title-2">{{\Gloudemans\Shoppingcart\Facades\Cart::tax().' VNĐ'}}</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="order-total-price">{{\Gloudemans\Shoppingcart\Facades\Cart::total().' VNĐ'}}</td>
                                                    </tr>
                                                </table>
                                                <?php
                                                ...
                                                ?>
                                                <a style="margin: 20px 0 0 370px;color: white" class="submit-btn-1 black-bg btn-hover-2 btn btn-default" type="submit" href="{{\Illuminate\Support\Facades\URL::to('payment')}}">
                                                    Thanh Toán
                                                </a>
                                                <?php
                                                }
